<?php
// source: C:\xampp\htdocs\sbweb\app/config/config.neon 
// source: C:\xampp\htdocs\sbweb\app/config/config.local.neon 

class Container_e96cc8be93 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\AdminModule\Presenters\ContentPresenter' => [1 => ['application.1']],
			'App\AdminModule\Presenters\GalleryPresenter' => [1 => ['application.2']],
			'App\AdminModule\Presenters\HomePagePresenter' => [1 => ['application.3']],
			'App\AdminModule\Presenters\ReferencePresenter' => [1 => ['application.4']],
			'App\AdminModule\Presenters\SeoPresenter' => [1 => ['application.5']],
			'App\AdminModule\Presenters\VideoPresenter' => [1 => ['application.6']],
			'App\CoreModule\Presenters\PagePresenter' => [1 => ['application.7']],
			'App\Presenters\Error4xxPresenter' => [1 => ['application.8']],
			'App\Presenters\ErrorPresenter' => [1 => ['application.9']],
			'App\Presenters\HomepagePresenter' => [1 => ['application.10']],
		...
		'services' => [
			...
			'application.1' => 'App\AdminModule\Presenters\ContentPresenter',
			...
			'application.4' => 'App\AdminModule\Presenters\ReferencePresenter',
			'application.5' => 'App\AdminModule\Presenters\SeoPresenter',
			'application.6' => 'App\AdminModule\Presenters\VideoPresenter',
			'application.7' => 'App\CoreModule\Presenters\PagePresenter',
	...
	{
		parent::__construct([
			'appDir' => 'C:\xampp\htdocs\sbweb\app',
			'wwwDir' => 'C:\xampp\htdocs\sbweb\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\xampp\htdocs\sbweb\app/../temp',
			'page' => 'Core:Page',
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\sbweb\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\sbweb\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\sbweb\app/../temp/cache',
	...
	{
		return new Container_e96cc8be93_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	{
		return new Container_e96cc8be93_IPub_VisualPaginator_Components_IControlImpl_visualPaginator_paginator($this);
	}
...
class Container_e96cc8be93_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_e96cc8be93 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\xampp\htdocs\sbweb\app/../temp/cache/latte');
...
class Container_e96cc8be93_IPub_VisualPaginator_Components_IControlImpl_visualPaginator_paginator implements IPub\VisualPaginator\Components\IControl
{
	private $container;
