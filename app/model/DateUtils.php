...
class DateUtils
{
	 ...
	 */
	private static $months = array('Leden', 'Únor', 'Březen', 'Duben', 'Květen', 'Červen', 'Červenec', 'Srpen', 'Září', 'Říjen', 'Listopad', 'Prosinec');
	/**
	...
	{
		$now = new DateTime();
		return $dateTime->format('j. ') . self::$months[$dateTime->format('n') - 1] . $dateTime->format(' Y');
	}
